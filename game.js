...
var I18N={
    ...
    version:(function(){var v='v20260326.64';return{zhs:v+' by \u767D\u6CB3\u6101',zht:v+' by \u767D\u6CB3\u6101',ja:v+' by \u767D\u6CB3\u6101',en:v+' by Kryso'};})(),
...
function handlePlayerInput(){
    ...
    if(len>0.1){
        ...
        if(_faceDiff>Math.PI*0.6){
            // Moving backward — delay turn for 0.2s
            if(!playerEgg._backstepTimer)playerEgg._backstepTimer=0;
            if(playerEgg._backstepTimer<=0)playerEgg._backstepTimer=12; // 0.2 second delay
            playerEgg.vx*=0.6;playerEgg.vz*=0.6; // slower backstep
        }
    }
    // Backstep timer — don't change facing while counting down, then allow turn
    ...
    if(playerEgg._hondaDash>0){
        ...
        if(!playerEgg._blankaRoll){
            ...
            playerEgg.mesh.position.y=Math.max(playerEgg.mesh.position.y,0.8); // fly above ground
        }
        ...
        if(playerEgg._hondaDash<=0){playerEgg.vx*=0.2;playerEgg.vz*=0.2;playerEgg._blankaRoll=false;playerEgg._dashDirX=undefined;playerEgg._dashDirZ=undefined;
            playerEgg.mesh.rotation.x=0; // reset horizontal pose
