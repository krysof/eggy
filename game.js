...
var I18N={
    ...
    version:(function(){var v='v20260326.70';return{zhs:v+' by \u767D\u6CB3\u6101',zht:v+' by \u767D\u6CB3\u6101',ja:v+' by \u767D\u6CB3\u6101',en:v+' by Kryso'};})(),
    ...
    if(playerEgg._hondaDash>0){
        ...
        if(!playerEgg._blankaRoll){
            if(playerEgg._dashDirX!==undefined){
                ...
                // Flatten horizontally — squash Y, stretch Z (torpedo shape)
                playerEgg.mesh.scale.set(1,0.4,2.5);
